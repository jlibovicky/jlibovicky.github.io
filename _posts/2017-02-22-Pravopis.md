...
o tom co dovede umělá inteligence (vyčpělé _artififfical intelligence_  se
s oblibou nahrazuje pojmem _machine intelligence_) – jak dovede vyřešit
automatický překlad, rozpoznávání řeči nebo běží na pozadí chytrých asistentů
jako [Google Home](https://madeby.google.com/home/) nebo [Amazon
...
[zdrojový kód](/assets/code/yi/statistical.py).
...
Můžete se podívat i na [zdrojový kód trénování](/assets/code/yi/train.py).
